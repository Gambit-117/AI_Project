# AI CHATBOT
Simple app that lets you have a verbal conversation with OpenAi's GPT 3.5.
Written by DougDoug, edited by Nate Williams. Feel free to use this for whatever you want! Credit is appreciated but not required.
...
## SETUP:
1) This was written in Python. Install page here: https://www.python.org/downloads/release/python-392/
...
4) This app uses the GPT-3.5-turbo model from OpenAi. As of this writing (Jan 13 2024), you need to pay $1 to OpenAi in order to get access to the GPT-4 model API. So after setting up your account with OpenAi, you will need to pay for at least $1 in credits so that your account is given the permission to use the GPT-4 model when running my app. See here: https://help.openai.com/en/articles/7102672-how-can-i-access-gpt-4
...
6) Elevenlabs is the service I use for Ai voices. Once you've made an i voice on the Elevenlabs website, open up chatgpt_character.py and replace the ELEVENLABS_VOICE variable with the name of your Ai voice.
